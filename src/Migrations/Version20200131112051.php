 ...
 */
final class Version20200131112051 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image CHANGE serie_id id_serie_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image CHANGE id_serie_id serie_id INT NOT NULL');
    }
}
